...
/**
 * Reemplaza [DatabaseModule] en tests instrumentados: DB en memoria en vez de la real del
 * dispositivo. Provee exactamente los mismos bindings que [DatabaseModule] (la DB + cada DAO).
 */
@Module
...
object TestDatabaseModule {
  @Provides
  @Singleton
  fun provideInMemoryDatabase(@ApplicationContext context: Context): LectoStartDatabase =
    Room.inMemoryDatabaseBuilder(context, LectoStartDatabase::class.java).allowMainThreadQueries().build()
